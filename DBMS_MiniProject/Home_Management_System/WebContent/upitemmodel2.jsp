...
<center><h2 style="position:relative;top:10px;border:none;background:black;font-color:whitefont-family: "Times New Roman", Times, serif;">Update ItemModel:</h2></center> <br>
</center>
<center>
<%
String name=" ";
...
//out.print(cc);
String sql="UPDATE `homedbms`.`itemmodel_table` SET `itemmodelname`='"+cc+"' WHERE `itemmodelid`='"+subcat+"'";
stmt.executeUpdate(sql);
 %>
<h3>Item is updated!!!</h3>
</center>
